...
@interface ZCTableViewAnimationKit ()


@end

@implementation ZCTableViewAnimationKit


+ (void)showWithAnimationType:(ZCTableViewAnimationType)animationType tableView:(UITableView *)tableView{
